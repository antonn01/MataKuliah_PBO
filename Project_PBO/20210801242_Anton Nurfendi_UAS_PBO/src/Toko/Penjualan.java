...
public class Penjualan extends javax.swing.JFrame {
    ...
    public void totalBiaya(){
        int jumlahBaris = from_data.getRowCount();
        int totalBiaya = 0;
        int jumlahBarang, hargaBarang;
        for (int i = 0; i < jumlahBaris; i++) {
            jumlahBarang = Integer.parseInt(from_data.getValueAt(i, 3).toString());
            hargaBarang = Integer.parseInt(from_data.getValueAt(i, 4).toString());
    ...
    public void loadData(){
        DefaultTableModel model = (DefaultTableModel) from_data.getModel();
    ...
    public Penjualan() {
        initComponents();
        setTitle("FROM PENJUALAN");
        setExtendedState(MAXIMIZED_BOTH);
        
        //Create Table
        model = new DefaultTableModel();
        
        from_data.setModel(model);
    ...
    private void initComponents() {
        ...
        from_data = new javax.swing.JTable();
        ...
        from_data.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(from_data);
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        // TODO add your handling code here:
        DefaultTableModel model = (DefaultTableModel) from_data.getModel();
        int row = from_data.getSelectedRow();
        model.removeRow(row);
        totalBiaya();
        txBayar.setText("0");
        txKembalian.setText("0");
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        String From_penyimpanan = null;
        String fromPenyimpanan = "";
        try {
        ...
        try {
            ...
            int baris = from_data.getRowCount();

            for (int j = 0; j < baris; j++) {
                fromPenyimpanan += from_data.getValueAt(j, 1) + " " + from_data.getValueAt(j, 2) + " " + from_data.getValueAt(j, 3) + " " + from_data.getValueAt(j, 4) + "\n";
            }

            for (int i = 0; i < baris; i++) {

                From_penyimpanan = "========== STRUK DATA PENJUALAN ========== \n"
                        + "NO. TRANSAKSI : " + from_data.getValueAt(i, 0)
                        + "\n" + fromPenyimpanan + "\n\n" + "Total Harga: "
                        + txTotalBayar.getText() + "\n" + "Bayar: "
                        + txBayar.getText() + "\n" + "Kembali: "
                        + txKembalian.getText() + "\n\n";
            ...
            try {
                for (int i = 0; i < From_penyimpanan.length(); i++) {
                    foutput.write((int) From_penyimpanan.charAt(i));
                }
            } catch (IOException e) {
        ...
        try {
            ...
            for (int i = 0; i < baris; i++) {
                String sql = "INSERT INTO penjualan_rinci(no_faktur, id_barang, nama_barang, jumlah, harga, total) VALUES('"
                        + from_data.getValueAt(i, 0) +"','"+ from_data.getValueAt(i, 1) +"','"+ from_data.getValueAt(i, 2) 
                        +"','"+ from_data.getValueAt(i, 3) +"','"+ from_data.getValueAt(i, 4) +"','"+ from_data.getValueAt(i, 5) 
                        +"')";
                PreparedStatement p = c.prepareStatement(sql);
                p.executeUpdate();
                p.close();
    ...
    private javax.swing.JTable from_data;
