...
public class DataBarang extends javax.swing.JFrame {
    ...
    private void autonumber(){
        try {
            ...
            if (r.next()) {
                ...
                txIDBarang.setText("AN" + Nol + BR);  
            }else{
                txIDBarang.setText("AN001");
            }
            r.close();
            s.close();
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        btnCetakData.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
    ...
    private void btnCetakDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakDataActionPerformed
        ...
        MessageFormat header = new MessageFormat("TABEL DATA BARANG");
